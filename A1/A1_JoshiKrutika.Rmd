...
The GSE number of the data set is GSE212591. 
...
### Mean-variance
The plot produced by Mean-variance Analysis examines how the DE gene changes with the mean. [@levy_prospect_2004]
In this plot, we can see that the variance increases with the mean level. 
So this means the genes present are expressed differently in different conditions causing an increase in variance. 
```{r}
